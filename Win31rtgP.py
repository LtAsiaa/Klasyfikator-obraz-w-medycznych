...
class Ui_MainWindow21(object):
    ...
    def openFile(self):
        ...
        filename, _ = QFileDialog.getOpenFileName(None, 'Buscar Imagen',
                                                  'C:\\Users\\Asia\\chest_xray\\test\\NORMAL',
                                                  'Image Files (*.png *.jpg *.jpeg *.bmp)')
    ...
    def prepare(self):
        ...
        new_array = cv2.resize(self.image, (IMG_SIZE, IMG_SIZE))
    ...
    def diagnoza(self):
        ...
        model = tf.keras.models.load_model(
            "C:\\Users\\Asia\\Desktop\\Klasyfikator obrazów\\PNEUMONIA\\1-test(32.1000)-only-train\\CNN.model")
